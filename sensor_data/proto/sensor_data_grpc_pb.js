...
function serialize_sensor_StreamRequest(arg) {
  if (!(arg instanceof sensor_data_pb.StreamRequest)) {
...
function deserialize_sensor_StreamRequest(buffer_arg) {
  return sensor_data_pb.StreamRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
streamSensorData: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: sensor_data_pb.StreamRequest,
